...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 265400655523351470, ; hash 0x3aee47d73a00bae, from name: BudgetAppLibray
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 8
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1168312829665140420, ; hash 0x1036ae541eb8dec4, from name: libaot-BudgetAppLibray
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 35
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.86_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2542555230622004756, ; hash 0x2348f882df093614, from name: BudgetAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2875576906403071050, ; hash 0x27e819f5fe78c44a, from name: aot-BudgetAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 90
	...
	%struct.DSOCacheEntry {
		i64 4606435212426938976, ; hash 0x3fed586b758f0a60, from name: libaot-BudgetAppLibray.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 137
	...
	%struct.DSOCacheEntry {
		i64 5064579263886175164, ; hash 0x46490001d8beabbc, from name: libaot-BudgetAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 144
	...
	%struct.DSOCacheEntry {
		i64 6804919080473566946, ; hash 0x5e6fedd984e79ee2, from name: aot-BudgetAppLibray.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 178
	...
	%struct.DSOCacheEntry {
		i64 7538506257146367183, ; hash 0x689e27800a44cccf, from name: aot-BudgetAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 206
	...
	%struct.DSOCacheEntry {
		i64 9520110153397989833, ; hash 0x841e39beabe071c9, from name: libaot-BudgetAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 275
	...
	%struct.DSOCacheEntry {
		i64 12007307110910528033, ; hash 0xa6a286332ed80a21, from name: BudgetAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 349
	...
	%struct.DSOCacheEntry {
		i64 13499353579212331004, ; hash 0xbb57568ec25957fc, from name: aot-BudgetAppLibray
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 397
	...
	%struct.DSOCacheEntry {
		i64 16670370800466643684, ; hash 0xe7590deb6bdbcae4, from name: BudgetAppLibray.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 481
...
@.env.3 = private unnamed_addr constant [37 x i8] c"8682f874-6b23-4701-8332-b3f71ad1b84c\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [33 x i8] c"com.companyname.budgetappproject\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [30 x i8] c"libaot-BudgetAppLibray.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [31 x i8] c"libaot-BudgetAppProject.dll.so\00", align 16
...
@.DSOCacheEntry.86_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
