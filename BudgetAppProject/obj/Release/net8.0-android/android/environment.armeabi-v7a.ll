...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 36488386, ; hash 0x22cc4c2, from name: aot-BudgetAppProject.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 78484898, ; hash 0x4ad95a2, from name: aot-BudgetAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 8
	...
	%struct.DSOCacheEntry {
		i64 569816611, ; hash 0x21f6b623, from name: aot-BudgetAppLibray.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 887001765, ; hash 0x34de92a5, from name: BudgetAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 101
	...
	%struct.DSOCacheEntry {
		i64 1154501435, ; hash 0x44d04b3b, from name: BudgetAppLibray
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 127
	...
	%struct.DSOCacheEntry {
		i64 1221344326, ; hash 0x48cc3c46, from name: BudgetAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		i64 1288032917, ; hash 0x4cc5d295, from name: libaot-BudgetAppLibray
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 143
	...
	%struct.DSOCacheEntry {
		i64 2447734801, ; hash 0x91e57811, from name: libaot-BudgetAppProject.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 294
	...
	%struct.DSOCacheEntry {
		i64 2758744761, ; hash 0xa46f1ab9, from name: libaot-BudgetAppProject
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-BudgetAppProject.dll.so
		ptr null; void* handle (0x0)
	}, ; 340
	...
	%struct.DSOCacheEntry {
		i64 3459761480, ; hash 0xce37c548, from name: BudgetAppLibray.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 430
	...
	%struct.DSOCacheEntry {
		i64 3576798061, ; hash 0xd5319b6d, from name: libaot-BudgetAppLibray.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 442
	...
	%struct.DSOCacheEntry {
		i64 4277329841, ; hash 0xfef2dfb1, from name: aot-BudgetAppLibray
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-BudgetAppLibray.dll.so
		ptr null; void* handle (0x0)
	}, ; 528
...
@.env.3 = private unnamed_addr constant [37 x i8] c"09363bca-a2ae-4d20-8996-3487992def07\00", align 1
